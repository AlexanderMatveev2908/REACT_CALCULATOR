...
const App = () => {
  ...
  return (
    <div className="w-full flex justify-center h-screen items-center">
      {/* CALCULATOR */}
      <div className="sm:min-w-[500px] sm:max-w-[500px] sm:h-[831px] sm:border border-[#222] rounded-[60px] w-fit">
        {/* HEADER */}
        ...
        <div className="w-full h-[630px] pt-[30px] pb-[40px] items-center">
          {/* CONTENT */}
          <div className="w-full h-[630px]  sm:px-[40px]">
            {/* TEXT BOARD */}
            <div className="w-full pb-[30px] flex justify-end">
              <span className="text-[65px] font-[400] text-white break-all px-[20px] sm:px-0">
                {resMath ?? textUser}
              </span>
            </div>
